...
Learn to use AI like a software engineer: clear prompts, clear plans, fast prototypes, safe code, and strong QA.

!!! note
    This site is organized by learning blocks. Open a block, then follow the projects inside it.
...
- :material-clipboard-text:{ .lg .middle } __AI-Assisted Planning__
  ...
  [:octicons-arrow-right-24: Open block](ai-assisted-planning/index.md)
...
- :material-code-braces:{ .lg .middle } __AI-Powered Development__
  ...
  [:octicons-arrow-right-24: Open block](ai-powered-development/index.md)
...
- :material-rocket-launch:{ .lg .middle } __MVP Development__
  ...
  [:octicons-arrow-right-24: Open block](mvp-development/index.md)
...
!!! tip
    For every project, aim to produce: a clear deliverable, a short prompt log (what you tried and why), and proof (tests, screenshots, logs, or reproducible steps).

!!! warning
    AI output is not proof. Always verify with checks you can repeat.
